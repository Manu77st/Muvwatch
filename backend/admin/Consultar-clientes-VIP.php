...
<body>
    ...
    <div class="menu-secundario">
        <nav>
            <a href="/Muvwatch/backend/admin/lobby_admin.php" class="enlace-a">Inicio</a>
            <a href="/Muvwatch/src/Reportes-ventas.html">Reportes</a>
            <a href="/Muvwatch/backend/admin/Consultar-clientes-VIP.php" style="border-bottom-color: #3b7ba6; background: #f5f5f5">Clientes VIP</a>
        </nav>
    </div>
