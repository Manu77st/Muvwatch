...
try {
    ...
    header('Location: /proyecto/Muvwatch/backend/admin/lobby_admin.php?msg=funcion_eliminada');
    exit;
} catch (Throwable $e) {
    ...
    echo '<p><a href="/proyecto/Muvwatch/backend/admin/lobby_admin.php">Volver al inicio</a></p>';
}
