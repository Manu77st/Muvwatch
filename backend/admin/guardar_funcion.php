...
if (!empty($errores)) {
    foreach ($errores as $e) {
     ...
     echo "<p><a href='/Muvwatch/src/añadir-funcion.html'>Volver al formulario</a></p>";
    exit;
}
...
try {
    ...
    if ($posterTmpPath && is_uploaded_file($posterTmpPath)) {
        ...
        $posterRelativeUrl = '/Muvwatch/uploads/posters/' . $posterFilename;
    ...
    header('Location: /Muvwatch/backend/admin/lobby_admin.php?msg=funcion_creada');
    exit;
