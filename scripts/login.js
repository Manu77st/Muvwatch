// Toggle mostrar/ocultar contraseña (si existe el botón)
...
if (btniniciarSesion) {
    btniniciarSesion.addEventListener('click', async (event) => {
        ...
        try {
            ...
            if (resultado.exito) {
                mostrarNotificacion(resultado.mensaje || 'Inicio de sesión exitoso', 'exito');
                const tipo = resultado.datos && resultado.datos.tipo_usuario ? resultado.datos.tipo_usuario.toLowerCase() : 'cliente';
                ...
                mostrarNotificacion(resultado.mensaje || 'Credenciales inválidas', 'error');
            }
